...
public class UserEdit {
	...
	UserEditDao userEditDao = UserEditDao.getInstance();
	...
	public int UserEdit(){
		...
		while (true) {
			...
			List<Map<String, Object>> userEdit = userEditDao.selectUser();
...
//				break;
			case 1:
				...
				List<Map<String, Object>> userEdit123 = userEditDao.selectUser1(sdfd);
				System.out.println("---------------------------------------------------------");
				for (Map<String, Object> user : userEdit123) {
					System.out.println("회원 이름 : " + user.get("USER_NAME") );
